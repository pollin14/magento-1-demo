...
class Entrepids_Giftregistry_Block_Adminhtml_Registries_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
            'label' => Mage::helper('entrepids_giftregistry')->__('Delete'),
            'url' => $this->getUrl('*/*/massDelete'),
            'confirm' => Mage::helper('entrepids_giftregistry')->__('Are you sure?')
        ));
        return $this;
    }
